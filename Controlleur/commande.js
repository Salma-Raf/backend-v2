    ...
    db.query(
      ...
      (err, data) => {
        ...
        for (let i = 0; i < t.length; i++) {
          const q = "SELECT * FROM commande,client,produit where  produit.`id-prod`=commande.`id-produit` and commande.`id-client`=client.`id-client`  and `n_panier`=? ORDER BY `date-achat` ";
